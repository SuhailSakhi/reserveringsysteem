...
if (isset($_POST['submit'])) {
    ...
    if (empty($errors)) {
        ...
        $query = "INSERT INTO registration (first_name, last_name, email,phone_number,password)
        ...
        <form class="column is-6" action="" method="post">
            <div class="field is-horizontal">
                ...
                <div class="field-body">
                    <div class="field">
                        <div class="control">
                            <input class="input" id="name" type="text" name="first_name" value="<?= $first_name ?? '' ?>"
                                   required/>
                        </div>
            ...
            <div class="field is-horizontal">
                ...
                <div class="field-body">
                    <div class="field">
                        <div class="control">
                            <input class="input" id="genre" type="text" name="email" value="<?= $email ?? '' ?>"
                                   required/>
                        </div>
                        <p class="help is-danger">
                            <?= $errors['email'] ?? '' ?>
